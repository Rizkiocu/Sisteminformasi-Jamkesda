                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown user user-menu">
                            ...
                            <ul class="dropdown-menu dropdown-usermenu pull-right" style=" width: 60px">
                                <li style="margin: 10px"><a href="<?php echo base_url('kepala/datapribadi/profile') ?>"> Profile</a></li>
                ...
                <ul class="sidebar-menu" data-widget="tree" style="font-size: 16px">
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu" style="padding-left: 20px">
                            <li><a href="<?php echo base_url('kepala/C_laporanbdt') ?>"><i class="fa fa-circle-o"></i>Surat BDT</a></li>
                            <li><a href="<?php echo base_url('kepala/C_laporannonbdt') ?>"><i class="fa fa-circle-o"></i> Surat Non BDT</a></li>
