            ...
            <div class="col-xs-12">
                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <a class="btn btn-danger" href="#edit<?= $u->nik; ?>" data-toggle="modal">Edit Password </a><br><br>
                        <div class="row" style="font-size: 13pt;">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <label class="col-md-5">Jenis Kelamin</label><label>: <span class="label label-primary label-form"><?php if ($u->jenis_kelamin == "Laki-Laki") {
                                                                                                                                            echo "Laki-Laki";
                                                                                                                                        } else {
                                                                                                                                            echo "Perempuan";
                                                                                                                                        } ?> </span></label>
    ...
    <div class="modal fade" id="edit<?php echo $u->nik ?>" tabindex="-1" role="dialog" aria-hidden="true" aria-labelledby="myModalLabel2">
        <div class="modal-dialog modal-nd">
            <div class="modal-content">
                ...
                <form class="form-horizontal form-label-left" action="<?php echo base_url('kepala/datapribadi/updatepassword'); ?>" method="post">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="hidden" class="form-control" name="nik" required="" value="<?php echo $u->nik ?>">
                            ...
                            <div class="col-sm-8" disabled>
                                <select class="form-control select2" name="level" style="width: 100%;" disabled="">
                                    ...
                                    <option <?php if ($u->level == '1') {
                                                echo 'selected';
                                            } ?> value="1">Operator Pelayanan</option>
                                    <option <?php if ($u->level == '2') {
                                                echo 'selected';
                                            } ?> value="2">Kepala Dinas Sosial</option>
