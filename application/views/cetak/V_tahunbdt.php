...
<body class="hold-transition skin-blue sidebar-mini">
  <p><?php foreach ($thn as $u) { ?><?php
                                    $tanggall = date('d', strtotime($u->tgl_suratkeluar));
                                    $bulan = date('m', strtotime($u->tgl_suratkeluar));
                                    $tahun = date('Y', strtotime($u->tgl_suratkeluar));
                                    $bulann = '';
                                    switch ($bulan) {
                                      case '01':
                                        $bulann = 'JANUARI';
    ...
    <tbody>
      ...
      ?>
        <tr>
          ...
          <td><?php $format = date('d-m-Y', strtotime($s->tgl_suratkeluar));
              echo $format ?></td>
