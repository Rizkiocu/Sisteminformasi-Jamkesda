        ...
        <div class="box-body">
          <div class="tab-content">
            <div class="tab-pane active" id="tab_1">
              <form class="form-horizontal" target="_blank" method="post" action="<?php echo base_url('admin/C_laporannonbdt/laporan_perbulan') ?>">
                <div class="row">
                  <div class="col-md-6">
                    <div class="row">
                      <div class="col-md-6">
            ...
            <div class="tab-pane" id="tab_2">
              <form class="form-horizontal" target="_blank" method="post" action="<?php echo base_url('admin/C_laporannonbdt/laporan_pertahun') ?>">
